"""
Final push for the last 4 storefronts to reach 30/30 each.
Storefronts:
- Acer Direct (19 -> 30)
- Elgiganten DK (20 -> 30)
- Elkjøp NO (22 -> 30)
...
FX_RATES = {
    "USD": 1.0, "INR": 0.012, "NOK": 0.094, "DKK": 0.145
}
...
FINAL_TARGETS = [
    {
        ...
        "queries": [
            "site:store.acer.com/en-in \"Aspire Lite\" OR \"TravelMate\" OR \"Swift Go\" INR",
            "site:store.acer.com/en-in/gaming \"Nitro V 15\" OR \"Predator Helios 16\" INR",
            "Acer India store laptop Intel Core i3 i5 i7 13th Gen buy price INR",
            "site:store.acer.com/en-in/laptops \"Intel Core\" thin light laptop INR"
        ]
    },
    {
        ...
        "queries": [
            "site:elgiganten.dk/product/computer-tablets \"bærbar pc\" Intel DKK",
            "site:elgiganten.dk/computer-tablets/barbar-computer Asus Zenbook Vivobook Intel DKK",
            "site:elgiganten.dk/computer-tablets/barbar-computer Lenovo IdeaPad Yoga Intel DKK",
            "site:elgiganten.dk/computer-tablets/barbar-computer HP Pavilion Envy Intel DKK"
        ]
    },
    {
        ...
        "queries": [
            "site:elkjop.no/product/pc-data-og-nettbrett/baerbar-pc Lenovo Yoga IdeaPad Intel NOK",
            "site:elkjop.no/product/pc-data-og-nettbrett/baerbar-pc HP Envy Pavilion Spectre Intel NOK",
            "site:elkjop.no/product/pc-data-og-nettbrett/baerbar-pc Asus ZenBook VivoBook Intel NOK",
            "site:elkjop.no/product/pc-data-og-nettbrett/baerbar-pc Acer Swift Aspire Nitro Intel NOK"
        ]
    },
    {
        ...
        "queries": [
            "site:staples.com/product HP Pavilion 15.6 inch laptop Intel Core",
            "site:staples.com/product Lenovo IdeaPad 3 5 15.6 laptop Intel",
            "site:staples.com/product Dell Inspiron 15 3520 laptop Intel Core",
            "site:staples.com/product ASUS Vivobook 15 16 laptop Intel Core"
        ]
    }
]
...
def harvest_final_four():
    print("=== Final Four Storefronts Push Starting ===")
            ...
            try:
                ...
                for lap in laptops:
                    ...
                    sku_obj = {
                        ...
                        "extraction_method": "FINAL_PUSH_MISTRAL",
    ...
    print(f"\n=== Final Push Finished. Total Master Database SKUs: {total_skus} ===")
