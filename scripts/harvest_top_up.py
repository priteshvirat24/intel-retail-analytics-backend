"""
Top-up script with broader search terms to hit 30/30 across all remaining 4 storefronts.
"""
...
TARGETS = [
    {
        ...
        "queries": [
            "Acer store India Intel Core i5 i7 laptop price list buy online",
            "Acer Aspire Swift Predator laptop price in India store.acer.com",
            "Acer Extensa TravelMate Spin laptop India Intel Core INR"
        ]
    },
    {
        ...
        "queries": [
            "Elkjøp bærbar PC Intel Core laptop pris NOK",
            "site:elkjop.no bærbar PC laptop Intel Core Ultra",
            "Elkjøp Norge laptop Asus Lenovo HP Acer Intel pris"
        ]
    },
    {
        ...
        "queries": [
            "Elgiganten bærbar computer Intel Core laptop pris DKK",
            "site:elgiganten.dk bærbar computer laptop Intel Core Ultra",
            "Elgiganten Danmark laptop Asus Lenovo HP Acer Intel pris"
        ]
    },
    {
        ...
        "queries": [
            "Staples laptops Intel Core i3 i5 i7 Touchscreen Windows 11 buy online",
            "site:staples.com laptops Intel Core Ultra HP Lenovo Dell",
            "Staples store laptop clearance deals Intel Core Windows 11"
        ]
    }
]
...
def harvest_top_up():
            ...
            try:
                ...
                for lap in laptops:
                    ...
                    sku_obj = {
                        ...
                        "gaming": "Y" if "gaming" in title.lower() or "rtx" in title.lower() or "predator" in title.lower() or "nitro" in title.lower() else "N",
                        ...
                        "extraction_id": f"bd-topup-{pid}",
                        "extraction_method": "TOPUP_MISTRAL",
    ...
    print(f"\n=== Top Up Finished. Total Master Database SKUs: {total_skus} ===")
