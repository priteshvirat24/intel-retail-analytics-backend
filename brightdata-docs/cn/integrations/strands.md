...
# 如何将 Bright Data 与 Strands Agents 集成

Strands Agents 是一个开源 Python 库，提供了用于开发自主 AI 代理的统一工具包。它通过提供现成的工具（文件操作、系统执行、API 交互、数学运算等），将大型语言模型与实际应用场景连接起来。
...
<Steps>
  ...
  <Step title="Bright Data 使用示例">
    <Tabs>
      <Tab title="在代理中使用 Bright Data 工具">
        <CodeGroup>
