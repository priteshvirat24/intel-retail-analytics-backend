...
> Bright Data's Acceptable Use Policy defines permitted and prohibited platform uses across 4 product areas, including restrictions on illegal activity.

Bright Data’s platform, technology, and network (collectively, “Services”) are meant for legitimate and legal purposes only and are subject to the [Bright Data Master Service Agreement](https://brightdata.com/license).
...
* Reselling of proxies without Bright Data’s prior written approval (see our [partners programs](https://brightdata.com/partners))
...
We encourage users to report any misuse or suspicious activity in our network through our dedicated email ([abuse@brightdata.com](mailto:abuse@brightdata.com)) or our reporting channel ([https://brightdata.com/report-abuse](https://brightdata.com/report-abuse)) .
