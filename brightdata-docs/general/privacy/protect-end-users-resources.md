...
# Protecting end user resources

> How Bright Data's idle monitor technology protects end users' battery, bandwidth and data plan across 3 resource categories when the device is a network node.
