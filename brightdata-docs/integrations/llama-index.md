...
> Connect Bright Data to LlamaIndex to enable your agent to crawl websites, search the web, and extract structured data from major platforms. Spans 195 countries.
