...
# Send your first ISP proxy request

> Send your first request through Bright Data ISP proxies with copy-paste code examples in cURL, Node.js, Python, PHP, Ruby, C#, Java, Perl and VBA.
...
The code above uses the ISP proxy to send a request to [http://brdtest.com/myip.json.](http://brdtest.com/myip.json.) It returns your IP information in a JSON format:
...
Now, replace “[https://brdtest.com/myip.json”](https://brdtest.com/myip.json”) with the website of your choice and ...
