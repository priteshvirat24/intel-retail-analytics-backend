...
<AccordionGroup>
  ...
  <Accordion title="Can I add enrichments after running my research?">
  ...
  <Accordion title="How do credits work during the trial?">
...
<CardGroup cols={3}>
  <Card title="Free Trial" icon="" href="https://brightdata.com/products/deep-lookup" cta="Start Free Trial">
    * \- 5 queries included
  ...
  <Card title="Pay As You Go" icon="" href="https://brightdata.com/products/deep-lookup" cta="Get Started">
  ...
  <Card title="Enterprise" icon="" href="mailto:sales@brightdata.com" cta="Contact Sales">
    * \- Volume discounts
    * \- Custom pricing
    * \- Dedicated support
    * \- API access
