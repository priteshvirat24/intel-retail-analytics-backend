...
# How to deliver LinkedIn data to Amazon S3

> Configure the Bright Data LinkedIn Scraper API to deliver scraped profiles, companies, jobs and posts directly to your Amazon S3 bucket on job completion.
