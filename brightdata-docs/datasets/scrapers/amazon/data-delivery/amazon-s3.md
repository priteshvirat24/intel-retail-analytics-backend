...
# Amazon data delivery to Amazon S3

> Configure the Bright Data Amazon Scraper API to deliver scraped product, review and seller data directly to your Amazon S3 bucket when each job completes.

This guide shows you how to configure the Bright Data Amazon Scraper API to deliver scraped data directly to your Amazon S3 bucket when a collection job completes.
...
2. Enter a bucket name (e.g., `amazon-scraper-data`)
...
Replace `amazon-scraper-data` with your actual bucket name.
...
4. Enter your credentials:
   ...
   * **Path prefix** (optional): A folder path within the bucket (e.g., `amazon/products/`)
