...
> Use the Bright Data Marketplace Dataset API to download Snapshot Content. GET /datasets/snapshots/{id}/download returns 200 OK with metadata as JSON.



## OpenAPI

````yaml api-reference/dca-api GET /datasets/snapshots/{id}/download
openapi: 3.1.0
info:
    ...
    get:
      ...
      x-codeSamples:
        - lang: shell
          ...
          source: |-
            curl --request GET \
              --url 'https://api.brightdata.com/datasets/snapshots/s_abc123/download?format=json' \
        ...
        - lang: python
          ...
          source: >-
            ...
            url =
            "https://api.brightdata.com/datasets/snapshots/s_abc123/download?format=json"
        ...
        - lang: javascript
          ...
          source: >-
            ...
            fetch("https://api.brightdata.com/datasets/snapshots/s_abc123/download?format=json",
            {
              method: "GET",
              headers: { "Authorization": "Bearer YOUR_API_KEY" },
            });
        ...
        - lang: js
          ...
          source: |-
            ...
            // Download a previously-prepared snapshot
            const rows = await ds.instagramProfiles.download('s_abc123');
            console.log(rows);
        ...
        - lang: php
          ...
          source: >-
            ...
            $ch =
            curl_init("https://api.brightdata.com/datasets/snapshots/s_abc123/download?format=json");
        ...
        - lang: go
          label: Go
          source: "package main\n\nimport (\n\t\"fmt\"\n\t\"io\"\n\t\"net/http\"\n)\n\nfunc main() {\n\treq, _ := http.NewRequest(\"GET\", \"https://api.brightdata.com/datasets/snapshots/s_abc123/download?format=json\", nil)\n\treq.Header.Set(\"Authorization\", \"Bearer YOUR_API_KEY\")\n\n\tres, err := http.DefaultClient.Do(req)\n\tif err != nil { panic(err) }\n\tdefer res.Body.Close()\n\n\tbody, _ := io.ReadAll(res.Body)\n\tfmt.Println(string(body))\n}"
        - lang: java
          label: Java
          source: |-
            import java.net.URI;
            ...
            public class Main {
                public static void main(String[] args) throws Exception {
                    HttpRequest request = HttpRequest.newBuilder()
                        .uri(URI.create("https://api.brightdata.com/datasets/snapshots/s_abc123/download?format=json"))
                        .header("Authorization", "Bearer YOUR_API_KEY")
        ...
        - lang: ruby
          ...
          source: >-
            ...
            uri =
            URI.parse("https://api.brightdata.com/datasets/snapshots/s_abc123/download?format=json")
