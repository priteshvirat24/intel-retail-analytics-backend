...
> Use the Bright Data Marketplace Dataset API to get Dataset Metadata. GET /datasets/{dataset_id}/metadata returns 200 OK with snapshot metadata as JSON.
...
```http theme={null}
GET https://api.brightdata.com/datasets/{dataset_id}/metadata
```
...
```http theme={null}
GET https://api.brightdata.com/datasets/gd_l1vijqt9jfj7olije/metadata
```
