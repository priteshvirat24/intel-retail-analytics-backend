...
> Use the Bright Data Account Management API to zone status. GET /zone/status returns 200 OK with zone or account configuration data as JSON.
...
````yaml api-reference/openapi GET /zone/status
openapi: 3.0.1
info:
