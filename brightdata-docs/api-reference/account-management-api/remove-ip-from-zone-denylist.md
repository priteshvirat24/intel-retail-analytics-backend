...
> Use the Bright Data Account Management API to remove IP from Zone denylist. DELETE /zone/blacklist returns 200 OK with zone or account JSON.
...
````yaml api-reference/openapi DELETE /zone/blacklist
openapi: 3.0.1
info:
