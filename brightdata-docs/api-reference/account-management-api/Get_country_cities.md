...
> Use the Bright Data Account Management API to get Country Cities. GET /cities returns 200 OK with zone or account configuration data as JSON.
...
````yaml api-reference/openapi GET /cities
openapi: 3.0.1
info:
