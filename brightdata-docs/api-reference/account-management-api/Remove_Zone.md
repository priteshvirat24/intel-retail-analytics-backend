...
> Use the Bright Data Account Management API to remove a Zone. DELETE /zone returns 200 OK with zone or account configuration data as JSON.
...
````yaml api-reference/openapi DELETE /zone
openapi: 3.0.1
info:
