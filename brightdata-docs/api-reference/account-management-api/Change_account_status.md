...
> Use the Bright Data Account Management API to change Account Status. PUT /status returns 200 OK with zone or account configuration data as JSON.
...
````yaml api-reference/openapi PUT /status
openapi: 3.0.1
info:
