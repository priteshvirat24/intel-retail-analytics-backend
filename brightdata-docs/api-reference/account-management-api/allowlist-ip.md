...
> Use the Bright Data Account Management API to allowlist IP(s). POST /zone/whitelist returns 200 OK with zone or account configuration data as JSON.
...
````yaml api-reference/openapi POST /zone/whitelist
openapi: 3.0.1
info:
