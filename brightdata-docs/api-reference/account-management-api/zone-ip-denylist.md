...
> Use the Bright Data Account Management API to list of denylisted IPs for a zone. GET /zone/blacklist returns 200 OK with zone or account JSON.
...
````yaml api-reference/openapi GET /zone/blacklist
openapi: 3.0.1
info:
...
paths:
  /zone/blacklist:
    get:
      description: Get a list of denylisted IPs for a specific Zone
      parameters:
        - in: query
          name: zones
          description: >-
