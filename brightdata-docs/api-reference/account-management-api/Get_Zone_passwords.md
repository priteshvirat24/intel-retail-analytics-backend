...
> Use the Bright Data Account Management API to zone Password. GET /zone/passwords returns 200 OK with zone or account configuration data as JSON.
...
````yaml api-reference/openapi GET /zone/passwords
openapi: 3.0.1
info:
