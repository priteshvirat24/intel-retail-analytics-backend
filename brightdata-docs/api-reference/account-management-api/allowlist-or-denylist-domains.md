...
> Use the Bright Data Account Management API to allowlist/Denylist Domain(s). POST /zone/domain_perm returns 200 OK with zone or account JSON.
...
````yaml api-reference/openapi POST /zone/domain_perm
openapi: 3.0.1
info:
