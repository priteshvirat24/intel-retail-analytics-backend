...
> Use the Bright Data Account Management API to live status of Static Zone. GET /zone/ips/unavailable returns 200 OK with zone or account JSON.
...
````yaml api-reference/openapi GET /zone/ips/unavailable
openapi: 3.0.1
info:
...
paths:
  /zone/ips/unavailable:
    get:
      description: >-
        Get live status of Static (Datacenter/ISP) Zone and IPs with
