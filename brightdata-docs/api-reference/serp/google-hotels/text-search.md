...
# Google Hotels text search

> Configure the Bright Data Google Hotels Google Hotels text search parameter to refine queries and return matching results as JSON or HTML. On port 44445.
