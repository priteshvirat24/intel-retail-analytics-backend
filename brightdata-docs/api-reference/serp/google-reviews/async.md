...
# Google Reviews async request

> Use the Bright Data Google Reviews async endpoint (31 languages). Submit a request, poll the job ID and retrieve results as JSON with 200 OK on success.
