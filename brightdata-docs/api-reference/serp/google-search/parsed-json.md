...
# Google Search parsed JSON

> Configure the Bright Data Google Search Google Search parsed JSON parameter to refine queries and return matching results as JSON or HTML. On port 44445.

```txt wrap theme={null}
https://www.google.com/search?q=pizza&brd_json=json
```
...
<RequestExample>
  ```shell cURL highlight={6} theme={null}
    ...
    --data '{
      "zone": "serp_api1",
      "url": "https://www.google.com/search?q=pizza&brd_json=json",
      "format": "raw"
    }'
  ```
