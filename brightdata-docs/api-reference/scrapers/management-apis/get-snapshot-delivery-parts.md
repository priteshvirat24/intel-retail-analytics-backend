...
> Use Bright Data Web Scraper API management endpoints to get Snapshot Delivery Parts. Endpoint: GET /datasets/v3/snapshot/{snapshot_id}/parts.



## OpenAPI

````yaml api-reference/dca-api get /datasets/v3/snapshot/{snapshot_id}/parts
openapi: 3.1.0
info:
