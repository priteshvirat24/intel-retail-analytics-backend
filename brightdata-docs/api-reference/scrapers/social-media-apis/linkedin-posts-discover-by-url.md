...
> Discover a LinkedIn user's posts by URL using the Bright Data Web Scraper API with dataset ID gd_lyy3tktm25m4avu764 for individual feed scraping.
...
<ParamField query="dataset_id" type="string" default="gd_lyy3tktm25m4avu764" required>
  ...
  <Warning>
    Must be set to `gd_lyy3tktm25m4avu764` to collect **Discover User's posts by URL** data.
  </Warning>
</ParamField>
