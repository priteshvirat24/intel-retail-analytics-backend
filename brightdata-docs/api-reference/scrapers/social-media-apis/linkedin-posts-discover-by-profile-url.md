...
> Discover LinkedIn posts from a profile URL using the Bright Data Web Scraper API with dataset ID gd_lyy3tktm25m4avu764 for individual feed monitoring.
...
<ParamField body="input" type="object[]" required>
  ...
  <Expandable title="properties">
    ...
    <ParamField body="only_authored_posts" type="boolean">
