...
# Discover Instagram reels by URL

> Use the Bright Data Web Scraper API to discover Instagram reels by URL. Calls the POST /datasets/v3/scrape endpoint and returns a snapshot ID.
...
<ParamField query="dataset_id" type="string" default="gd_lyclm20il4r5helnj" required>
  ...
  <Warning>
    Must be set to `gd_lyclm20il4r5helnj` to collect **Discover by URL** data.
  </Warning>
</ParamField>
