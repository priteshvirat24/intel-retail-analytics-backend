...
# Collect Instagram profiles by URL

> Use the Bright Data Web Scraper API to collect Instagram profiles by URL. Calls the POST /datasets/v3/scrape endpoint and returns a snapshot ID.
...
<ParamField query="dataset_id" type="string" default="gd_l1vikfch901nx3by4" required>
  ...
  <Warning>
    Must be set to `gd_l1vikfch901nx3by4` to collect **Profiles by URL** data.
  </Warning>
</ParamField>
...
<ParamField body="input" type="object[]" required>
  ...
  <Expandable title="properties">
    <ParamField body="url" type="string" required>
      The URL of the Instagram profile to collect.
    </ParamField>
  </Expandable>
...
````yaml api-reference/sdk-specs/instagram-profiles-collect-by-url POST /datasets/v3/scrape
openapi: 3.0.0
info:
  title: Collect Instagram profiles by URL
  version: 1.0.0
servers:
...
paths:
  /datasets/v3/scrape:
    post:
      summary: Collect Instagram profiles by URL
      description: >-
        Use the Bright Data Web Scraper API to collect Instagram profiles by
      ...
      parameters:
        - in: query
          ...
          schema:
            type: string
            default: gd_l1vikfch901nx3by4
          description: Must be `gd_l1vikfch901nx3by4` for this dataset.
        - in: query
          name: notify
          required: false
          schema:
      ...
      x-codeSamples:
        - lang: shell
          ...
          source: |-
            curl --request POST \
              --url 'https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1vikfch901nx3by4&include_errors=true' \
              --header "Authorization: Bearer YOUR_API_KEY" \
              --header "Content-Type: application/json" \
              --data '{"input": [{"url": "https://www.instagram.com/cats_of_world_"}, {"url": "https://www.instagram.com/dogsofinstagram"}, {"url": "https://www.instagram.com/zoobarcelona"}, {"url": "https://www.instagram.com/australiazoo"}]}'
        - lang: python
          label: Python
          source: >-
            import requests
            ...
            url =
            "https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1vikfch901nx3by4&include_errors=true"
        ...
        - lang: py
          ...
          source: |-
            ...
            async with BrightDataClient(api_key="YOUR_API_KEY") as client:
                result = await client.scrape.instagram.profiles(url="https://www.instagram.com/natgeo/")
                print(result.data)
        - lang: javascript
          label: JavaScript
          source: >-
            const response = await
            fetch("https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1vikfch901nx3by4&include_errors=true",
            {
              method: "POST",
              headers: {
                "Authorization": "Bearer YOUR_API_KEY",
        ...
        - lang: js
          ...
          source: >-
            ...
            const result = await
            client.scrape.instagram.collectProfiles(['https://www.instagram.com/natgeo/']);
        ...
        - lang: php
          ...
          source: >-
            ...
            $ch =
            curl_init("https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1vikfch901nx3by4&include_errors=true");
        ...
        - lang: go
          label: Go
          source: "package main\n\nimport (\n\t\"bytes\"\n\t\"fmt\"\n\t\"io\"\n\t\"net/http\"\n)\n\nfunc main() {\n\tpayload := []byte(\"{\\\"input\\\": [{\\\"url\\\": \\\"https://www.instagram.com/cats_of_world_\\\"}, {\\\"url\\\": \\\"https://www.instagram.com/dogsofinstagram\\\"}, {\\\"url\\\": \\\"https://www.instagram.com/zoobarcelona\\\"}, {\\\"url\\\": \\\"https://www.instagram.com/australiazoo\\\"}]}\")\n\treq, _ := http.NewRequest(\"POST\", \"https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1vikfch901nx3by4&include_errors=true\", bytes.NewBuffer(payload))\n\treq.Header.Set(\"Authorization\", \"Bearer YOUR_API_KEY\")\n\treq.Header.Set(\"Content-Type\", \"application/json\")\n\n\tres, err := http.DefaultClient.Do(req)\n\tif err != nil { panic(err) }\n\tdefer res.Body.Close()\n\n\tbody, _ := io.ReadAll(res.Body)\n\tfmt.Println(string(body))\n}"
        - lang: java
          label: Java
          source: |-
            import java.net.URI;
            ...
            public class Main {
                public static void main(String[] args) throws Exception {
                    String body = "{\"input\": [{\"url\": \"https://www.instagram.com/cats_of_world_\"}, {\"url\": \"https://www.instagram.com/dogsofinstagram\"}, {\"url\": \"https://www.instagram.com/zoobarcelona\"}, {\"url\": \"https://www.instagram.com/australiazoo\"}]}";
                    HttpRequest request = HttpRequest.newBuilder()
                        .uri(URI.create("https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1vikfch901nx3by4&include_errors=true"))
                        .header("Authorization", "Bearer YOUR_API_KEY")
                        .header("Content-Type", "application/json")
        ...
        - lang: ruby
          ...
          source: >-
            ...
            uri =
            URI.parse("https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1vikfch901nx3by4&include_errors=true")
            ...
            "https://www.instagram.com/cats_of_world_"}, {"url":
            "https://www.instagram.com/dogsofinstagram"}, {"url":
            "https://www.instagram.com/zoobarcelona"}, {"url":
            "https://www.instagram.com/australiazoo"}]}.to_json
