...
````yaml api-reference/sdk-specs/tiktok-profiles-collect-by-url POST /datasets/v3/scrape
openapi: 3.0.0
info:
  title: Collect TikTok profiles by URL
  version: 1.0.0
servers:
...
paths:
  /datasets/v3/scrape:
    post:
      summary: Collect TikTok profiles by URL
      description: >-
        Use the Bright Data Web Scraper API to collect TikTok profiles by URL.
      ...
      parameters:
        - in: query
          ...
          description: Must be `gd_l1villgoiiidt09ci` for this dataset.
        - in: query
          name: notify
          required: false
          schema:
      ...
      x-codeSamples:
        ...
        - lang: python
          ...
          source: >-
            ...
            url =
            "https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1villgoiiidt09ci&include_errors=true"
        ...
        - lang: py
          ...
          source: |-
            ...
            async with BrightDataClient(api_key="YOUR_API_KEY") as client:
                result = await client.scrape.tiktok.profiles(url="https://www.tiktok.com/@tiktok")
                print(result.data)
        - lang: javascript
          label: JavaScript
          source: >-
            const response = await
            fetch("https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1villgoiiidt09ci&include_errors=true",
            {
              method: "POST",
              headers: {
                "Authorization": "Bearer YOUR_API_KEY",
        ...
        - lang: js
          ...
          source: >-
            ...
            const result = await
            client.scrape.tiktok.collectProfiles(['https://www.tiktok.com/@tiktok']);
        ...
        - lang: php
          ...
          source: >-
            ...
            $ch =
            curl_init("https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1villgoiiidt09ci&include_errors=true");
        ...
        - lang: go
          label: Go
          source: "package main\n\nimport (\n\t\"bytes\"\n\t\"fmt\"\n\t\"io\"\n\t\"net/http\"\n)\n\nfunc main() {\n\tpayload := []byte(\"{\\\"input\\\": [{\\\"url\\\": \\\"https://www.tiktok.com/@mrbeast\\\"}, {\\\"url\\\": \\\"https://www.tiktok.com/@charlidamelio\\\"}]}\")\n\treq, _ := http.NewRequest(\"POST\", \"https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1villgoiiidt09ci&include_errors=true\", bytes.NewBuffer(payload))\n\treq.Header.Set(\"Authorization\", \"Bearer YOUR_API_KEY\")\n\treq.Header.Set(\"Content-Type\", \"application/json\")\n\n\tres, err := http.DefaultClient.Do(req)\n\tif err != nil { panic(err) }\n\tdefer res.Body.Close()\n\n\tbody, _ := io.ReadAll(res.Body)\n\tfmt.Println(string(body))\n}"
        - lang: java
          label: Java
          source: |-
            import java.net.URI;
            ...
            public class Main {
                public static void main(String[] args) throws Exception {
                    String body = "{\"input\": [{\"url\": \"https://www.tiktok.com/@mrbeast\"}, {\"url\": \"https://www.tiktok.com/@charlidamelio\"}]}";
                    HttpRequest request = HttpRequest.newBuilder()
                        .uri(URI.create("https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1villgoiiidt09ci&include_errors=true"))
                        .header("Authorization", "Bearer YOUR_API_KEY")
                        .header("Content-Type", "application/json")
        ...
        - lang: ruby
          ...
          source: >-
            ...
            uri =
            URI.parse("https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_l1villgoiiidt09ci&include_errors=true")
            ...
            "https://www.tiktok.com/@mrbeast"}, {"url":
            "https://www.tiktok.com/@charlidamelio"}]}.to_json
