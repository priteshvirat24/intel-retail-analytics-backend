...
<ParamField query="dataset_id" type="string" default="gd_lwxkxvnf1cynvib9co" required>
  ...
  <Warning>
    Must be set to `gd_lwxkxvnf1cynvib9co` to collect **Posts by URL** data.
  </Warning>
</ParamField>
...
<ParamField body="input" type="object[]" required>
  ...
  <Expandable title="properties">
    <ParamField body="url" type="string" required>
      The URL of the X.com post to collect.
    </ParamField>
  </Expandable>
  ...
  ```json wrap theme={null}
  {
    "input": [
      ...
      {"url": "https://x.com/OpenAI/status/9876543210987654321"}
    ]
  }
  ```
</ParamField>
