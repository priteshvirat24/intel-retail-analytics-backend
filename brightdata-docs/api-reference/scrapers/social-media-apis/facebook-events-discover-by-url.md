...
# Discover events by URL

> Use the Bright Data Web Scraper API to discover Events by URL. POST /datasets/v3/scrape starts a scraping job that returns the data as structured JSON records.
...
<ParamField body="input" type="object[]" required>
  ...
  <Expandable title="properties">
    <ParamField body="url" type="string" required>
      The Facebook events page URL to discover events from.
    </ParamField>
  </Expandable>
  ...
  {
    "input": [
      {"url": "https://www.facebook.com/events/search/?q=tech+conference"},
