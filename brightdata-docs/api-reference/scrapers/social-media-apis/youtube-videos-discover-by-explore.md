...
# Discover videos by explore

> Use the Bright Data Web Scraper API to discover Videos by Explore. Calls the POST /datasets/v3/scrape endpoint and returns a snapshot ID.
...
<ParamField query="dataset_id" type="string" default="gd_lk56epmy2i5g7lzu0k" required>
  ...
  <Warning>
    Must be set to `gd_lk56epmy2i5g7lzu0k` to collect **Discover Videos by Explore** data.
  </Warning>
</ParamField>
...
<ParamField query="discover_by" type="string" default="explore">
  Must be set to `explore`.
</ParamField>
...
<ParamField body="input" type="object[]" required>
  ...
  <Expandable title="properties">
    <ParamField body="url" type="string" required>
      The YouTube explore page URL to discover videos from.
    </ParamField>
  </Expandable>
